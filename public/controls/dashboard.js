                ...
                <div id="tabs" class="content">
                    ...
                    <div class="tabpage">
                        ...
                        <div class="row text-center">
                            ...
                            Shout out to <a href="https://unsplash.com/" target="_blank" rel="noopener noreferrer">Unsplash</a> for the amazing photography. <br /> Copyright &copy; ${new Date().getFullYear()} Stanley Lim. Crafted with <a target="_blank" href=https://spiderpig86.github.io/Cirrus class="u utb-C" rel="noopener noreferrer">Cirrus</a></p>
                            <space class="x-large"></space>
                            <div class="row center">
                                <a href="https://github.com/Spiderpig86/Nimbus" target="_blank" rel="noopener noreferrer"><button class="btn-nimbus">Github</button></a>
                            </div>
                        </div>
                    </div>
                </div>
