                                ...
                                <div class="song-desc">
                                    <div class="content-no-padding">
                                        <div class="row text-center" id="descNavBar">
                                            ...
                                            <a href="${track.permalink_url + '/comments'}" target="_blank"><div class="btn-container this-inline-block"><button class="btn-transparent" id="desc-comments"><i class="fa fa-comment small" aria-hidden="true"></i><span>${track.comment_count || 0}</span></button></div></a>
                                            ...
                                            <a href="${track.user.permalink_url}" target="_blank"><div class="btn-container this-inline-block"><button class="btn-transparent" id="desc-user"><i class="fa fa-user small" aria-hidden="true"></i><span>${track.user.username}</span></button></div></a>
                                            <a href="${track.user.purchase_url || errorPurchase}" target="_blank"><div class="btn-container this-inline-block"><button class="btn-transparent" id="desc-buy"><i class="fa fa-usd small" aria-hidden="true"></i><span>Purchase</span></div></button></a>
                                        </div>
