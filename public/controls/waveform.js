...
class WaveForm {
    ...
    constructor(params) {
        ...
        this.updateInterval = (Settings.getPref('disableBlur') === 'true' ? 100 : 10); // Update every whatever metric SC uses
    ...
    async updateWaveformData(data) {
        ...
        this.updateInterval = (Settings.getPref('disableBlur') === 'true' ? 100 : 10); 
        this.drawWaveForm();
    }
