            ...
            widget.bind(SC.Widget.Events.PLAY_PROGRESS, (e) => {
                ...
                if (e.currentPosition === 0) {
                    if (this.isPlaylist && !this.isRepeating) {
                        ...
                        setTimeout(() => {this.seekingForward = false, 500});
                        console.log(2);
                    }
                }
            });
