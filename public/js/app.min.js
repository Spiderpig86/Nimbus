...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__controls_songinfo__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__controls_waveform__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__request__ = __webpack_require__(7);
            ...
            if (e.keyCode === 13) {
                ...
                if (searchQuery.startsWith('http') && isNaN(searchQuery)) { // Check if this is a url
                    ...
                    if (searchQuery.startsWith('playlist:') || searchQuery.startsWith('set:')) {
                        ...
                        this.isPlaylist = false;
                    } else if (searchQuery.startsWith('genres:')) {
