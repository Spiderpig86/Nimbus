...
class Player {
    ...
    async getTracksFromCharts(_kind, _genres, _limit, $_partition = 1) {
        ...
        try {
            console.log(`https://api-v2.soundcloud.com/charts?kind=${_kind}&genre=${_genres}&limit=${_limit}&linked_partitioning=${$_partition}&client_id=${__WEBPACK_IMPORTED_MODULE_0__consts_sec_json___default.a.client_id}`);
            let req = new __WEBPACK_IMPORTED_MODULE_4__request__["a" /* default */](); // Construct it
            let tracks = await req.getJSON(`https://api-v2.soundcloud.com/charts?kind=${_kind}&genre=${_genres}&limit=${_limit}&linked_partitioning=${$_partition}&client_id=${__WEBPACK_IMPORTED_MODULE_0__consts_sec_json___default.a.client_id}`);
            console.log(tracks);
        } catch (e) {
