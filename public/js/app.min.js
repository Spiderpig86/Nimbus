...
class Player {
    ...
    async getTracksFromCharts(_kind, _genres, _limit, $_partition = 1) {
        ...
        try {
            ...
            console.log(`${window.location.href}php/index.php?kind=${_kind}&genre=${_genres}&limit=${_limit}&linked_partitioning=${$_partition}&client_id=${__WEBPACK_IMPORTED_MODULE_0__consts_sec_json___default.a.client_id}`);
            oReq.open("get", `${window.location.href}php/index.php?kind=${_kind}&genre=${_genres}&limit=${_limit}&linked_partitioning=${$_partition}&client_id=${__WEBPACK_IMPORTED_MODULE_0__consts_sec_json___default.a.client_id}`, true);
...
class Search {
    ...
    loadCharts() {
        ...
        let c = new __WEBPACK_IMPORTED_MODULE_0__chartitem__["a" /* default */](this._player, "Dance & EDMTop 50", "SoundCloud", "top", "soundcloud%3Agenres%3Adanceedm", 50);
