...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__controls_songinfo__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__controls_waveform__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__request__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__controls_search__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__controls_toast__ = __webpack_require__(8);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__controls_queueitem__ = __webpack_require__(5);
    ...
    bindEvents() {
        ...
        this.queueTab.onclick = (e) => {
            ...
            for (let i = 0; i < this._player.queue.length; i++) {
                let q = new __WEBPACK_IMPORTED_MODULE_0__controls_queueitem__["a" /* default */](this._player, this._player.queue[i]);
    ...
    render() {
        return `
            <div class="queue-item">
                <h6 class="title light"><span>${this._track.title}</span><span class="pull-right">${this._track.duration}</span></h6>
                <p class="subtitle"><span>${this._track.user}</span><span class="queue-item-actions pull-right">
