...
class Dashboard {
    ...
    refreshQueueContainer() {
        ...
        document.querySelector('#totalQueueTime').innerText = __WEBPACK_IMPORTED_MODULE_1__js_utils__["a" /* default */].convertMillisecondsToDigitalClock(this.queuedTime).clock;
    }
