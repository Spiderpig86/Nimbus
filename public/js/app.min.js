    ...
    getRandomTrack() {
        try {
            ...
            SC.get('/tracks/' + id).then((track) => { // Check if there are results
                    ...
                    this.histContainer.innerHTML += __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__controls_HistItem__["a" /* default */])((track.artwork_url === null ? '../img/cd.png' : track.artwork_url), track.title, track.artist, track); // Append to history
