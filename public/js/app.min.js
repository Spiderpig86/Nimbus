...
class Player {
    ...
    getTrackById(id) {
        ...
        try {
            ...
            SC.stream(`/tracks/${id}?client_id=${__WEBPACK_IMPORTED_MODULE_0__consts_json___default.a.client_id}`).then((player) => {
