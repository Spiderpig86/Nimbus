...
class Search {
    ...
    loadCharts() {
        ...
        let c = new __WEBPACK_IMPORTED_MODULE_0__chartitem__["a" /* default */](this._player, "Dance & EDM Top 50", "SoundCloud", "top", "soundcloud%3Agenres%3Adanceedm", 50);
        this.chartContainer.appendChild(c.render());
        c = new __WEBPACK_IMPORTED_MODULE_0__chartitem__["a" /* default */](this._player, "Rap Top 50", "SoundCloud", "top", "soundcloud%3Agenres%3Ahiphoprap", 50);
        this.chartContainer.appendChild(c.render());
    }
