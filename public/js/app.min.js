            ...
            widget.getCurrentSound((song) => {
                ...
                if (this.history.length > 0 || this.queue.length > 0) {
                    ...
                    if (!found) { // Append the song if not found
                        ...
                        this.histContainer.innerHTML += __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__controls_HistItem__["a" /* default */])((song.artwork_url === null ? song.user.avatar_url : song.artwork_url), (song.artwork_url === null ? rndImg : song.artwork_url), song.title, this.widgetTrack.artist, song, `https://api.soundcloud.com/tracks/${song.id}/download?client_id=${__WEBPACK_IMPORTED_MODULE_0__consts_sec_json___default.a.client_id}`,  "javascript:alert('Download link unavailable');"); // Append to history
