    ...
    getRandomTrack() {
        try {
            ...
            SC.get('/tracks/' + id).then((track) => { // Check if there are results
                    ...
                    this.histContainer.innerHTML += __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__controls_HistItem__["a" /* default */])((track.artwork_url === null ? '../img/cd.png' : track.artwork_url), (track.artwork_url === null ? 'https://images.unsplash.com/photo-1466853817435-05b43fe45b39?dpr=1&auto=format&fit=crop&w=1500&h=1090&q=80&cs=tinysrgb&crop=&bg=' : track.artwork_url), track.title, track.user.username === undefined ? 'N/A' : track.user.username, track); // Append to history
