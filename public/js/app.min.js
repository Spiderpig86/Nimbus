    ...
    refreshQueueContainer() {
        ...
        if (this._player.queue.length > 0 ) {
            ...
            for (let i = this._player.queue.length - 1; i >= 0; i--) {
                q = new __WEBPACK_IMPORTED_MODULE_0__queueitem__["a" /* default */](this._player, this, this._player.queue[i].track);
