    ...
    loadWidgetSong(widget) {
        try {
            ...
            widget.getCurrentSound((song) => {
                ...
                this.mainPlayer.innerHTML = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__controls_songinfo__["a" /* default */])((song.artwork_url === null ? song.user.avatar_url : song.artwork_url.replace('large', 't500x500')), song);
                ...
                if (!this.history.includes(song)) { // Do not add if it already exists
                    ...
                    this.histContainer.innerHTML += __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__controls_HistItem__["a" /* default */])((song.artwork_url === null ? song.user.avatar_url : song.artwork_url), (song.artwork_url === null ? rndImg : song.artwork_url), song.title, song.user.username === undefined ? 'N/A' : song.user.username, song); // Append to history
                }
