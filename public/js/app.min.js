...
class Player {
    ...
    fetchNext() {
        ...
        console.log(__WEBPACK_IMPORTED_MODULE_9__settings__["a" /* default */].getPref('shuffleMode') === 'related');
...
class Dashboard {
    ...
    updateControls() {
        ...
        if (JSON.stringify(__WEBPACK_IMPORTED_MODULE_2__js_settings__["a" /* default */].getPref('shuffleMode')) === 'random')
