    ...
    loadWidgetSong(widget) {
        try {
            ...
            widget.getCurrentSound((song) => {
                ...
                this.mainPlayer.innerHTML = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__controls_songinfo__["a" /* default */])((song.artwork_url === null ? song.user.avatar_url : song.artwork_url.replace('large', 't500x500')), song, tagBtns);
