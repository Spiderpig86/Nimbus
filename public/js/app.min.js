    ...
    getRandomTrack() {
        try {
            ...
            SC.get('/tracks/' + id).then((track) => { // Check if there are results
                    ...
                    this.histContainer.innerHTML += __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__controls_HistItem__["a" /* default */])(this.artwork_url, track.title, track.artist, track); // Append to history

                    // Update main player info
                    this.mainPlayer.innerHTML = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__controls_songinfo__["a" /* default */])(this.artwork_url, track);
