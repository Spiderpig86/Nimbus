...
class Player {
    ...
    async getTracksFromCharts(_kind, _genres, _limit, $_partition = 1) {
        ...
        try {
            ...
            oReq.open("get", "http://polarity.x10.mx/test.php?kind=top&genre=soundcloud%3Agenres%3Adanceedm&limit=50&linked_partitioning=1&client_id=2t9loNQH90kzJcsFCODdigxfp325aq4z", true);
