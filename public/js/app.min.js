...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__controls_openExternalBtn__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__controls_openExternalBtn___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__controls_openExternalBtn__);
...
class Player {
        ...
        try {
            ...
            SC.get('/tracks/' + id).then((tracks) => { // Check if there are results
                if (tracks !== undefined) {
                    ...
                    this.histContainer.innerHTML += __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__controls_HistItem__["a" /* default */])(this.artwork_url, this.title, this.artist, tracks);
                    console.log(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__controls_HistItem__["a" /* default */])(this.artwork_url, this.title, this.artist, tracks));
                    return id;
                } else {
                    // Find another track
                    this.getRandomTrack();
    ...
    async getTrackById(id) {
        ...
        try {
            ...
            await SC.stream(`/tracks/${id}?client_id=${__WEBPACK_IMPORTED_MODULE_0__consts_json___default.a.client_id}`).then((player) => {
