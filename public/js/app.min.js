...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__consts_json__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__consts_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__consts_json__);
...
class Player {
    ...
    start() {
        try {
            SC.initialize({client_id: __WEBPACK_IMPORTED_MODULE_0__consts_json___default.a.client_id});
        } catch(e) {
    ...
    getRandomTrack() {
        try {
            ...
            SC.get('/tracks/' + id).then((track) => { // Check if there are results
                    ...
                    this.histContainer.innerHTML += __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__controls_HistItem__["a" /* default */])((track.artwork_url === null ? '../img/cd.png' : track.artwork_url), track.title, track.user.username === undefined ? 'N/A' : track.user.username, track); // Append to history
    ...
    async getTrackById(id) {
        // Create a stream call to the SoundCloud object.
            ...
            return await SC.stream(`/tracks/${id}?client_id=${__WEBPACK_IMPORTED_MODULE_0__consts_json___default.a.client_id}`).then((player) => {
