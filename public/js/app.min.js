...
class Player {
    ...
    async getTracksFromCharts(_kind, _genres, _limit, $_partition = 1) {
        ...
        try {
            ...
            console.log(`${window.location.href}php/charts.php?kind=${_kind}&genre=${_genres}&limit=${_limit}&linked_partitioning=${$_partition}&client_id=${__WEBPACK_IMPORTED_MODULE_0__consts_sec_json___default.a.client_id}`);
            oReq.open("get", `${window.location.href}php/charts.php?kind=${_kind}&genre=${_genres}&limit=${_limit}&linked_partitioning=${$_partition}&client_id=${__WEBPACK_IMPORTED_MODULE_0__consts_sec_json___default.a.client_id}`, true);
