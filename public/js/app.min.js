...
class Player {
        ...
        document.onkeyup = (e) => {
            if (e.keyCode == 39) {
                ...
                SC.get('/tracks/' + id).then((track) => { // Check if there are results
                    ...
                    this.mainPlayer.innerHTML = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__controls_songinfo__["a" /* default */])((track.artwork_url === null ? '../img/cd.png' : track.artwork_url.replace('large', 't500x500')), track);
                    this.histContainer.innerHTML += __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__controls_HistItem__["a" /* default */])((track.artwork_url === null ? '../img/cd.png' : track.artwork_url), (track.artwork_url === null ? rndImg : track.artwork_url), track.title, track.user.username === undefined ? 'N/A' : track.user.username, track); // Append to history
    ...
    loadWidgetSong(widget) {
        ...
        widget.getCurrentSound((song) => {
            ...
            this.mainPlayer.innerHTML = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__controls_songinfo__["a" /* default */])((song.artwork_url === null ? '../img/cd.png' : song.artwork_url.replace('large', 't500x500')), song);
            this.histContainer.innerHTML += __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__controls_HistItem__["a" /* default */])((song.artwork_url === null ? '../img/cd.png' : song.artwork_url), (song.artwork_url === null ? rndImg : song.artwork_url), song.title, song.user.username === undefined ? 'N/A' : song.user.username, song); // Append to history
            //this.curTrack.track = track;
        });
    }
    ...
    start() {
        try {
            SC.initialize({client_id: __WEBPACK_IMPORTED_MODULE_0__consts_sec_json___default.a.client_id});
        } catch(e) {
    ...
    async getTrackById(id) {
        ...
        return await SC.stream(`/tracks/${id}?client_id=${__WEBPACK_IMPORTED_MODULE_0__consts_sec_json___default.a.client_id}`).then((player) => {
    ...
    togglePlay() {
        if (!this.isPlaying) {
            ...
            this.isPlaying = true;
            this.mainPlayer.innerHTML = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__controls_songinfo__["a" /* default */])((this.curTrack.track.artwork_url === null ? '../img/cd.png' : this.curTrack.track.artwork_url.replace('large', 't500x500')), this.curTrack.track);
