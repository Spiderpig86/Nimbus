...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__consts_sec_json__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__controls_HistItem__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__controls_songinfo__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__controls_waveform__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__request__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__controls_search__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__controls_toast__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__controls_dashboard__ = __webpack_require__(5);
...
class Player {
    ...
    bindWidgetEvents(widget) {
        ...
        widget.bind(SC.Widget.Events.READY, (e) => {
            ...
            widget.bind(SC.Widget.Events.PLAY_PROGRESS, (e) => {
                ...
                let curTimeStr = __WEBPACK_IMPORTED_MODULE_8__utils__["a" /* default */].millisToMinutesAndSeconds(e.currentPosition);
                let totalTimeStr = __WEBPACK_IMPORTED_MODULE_8__utils__["a" /* default */].millisToMinutesAndSeconds(this.widgetTrack.duration);
    ...
    showToast(message) {
        this.toastContainer.innerHTML = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__controls_toast__["a" /* default */])(message, '');
        setTimeout(function() { 
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__controls_queueitem__ = __webpack_require__(6);
    ...
    refreshQueueContainer() {
        if (this._player.queue.length > 0 ) {
            ...
            for (let i = this._player.queue.length - 1; i >= 0; i--) {
                q = new __WEBPACK_IMPORTED_MODULE_0__controls_queueitem__["a" /* default */](this._player, this._player.queue[i]);
                frag += q.render();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__js_utils__ = __webpack_require__(2);
    ...
    render() {
        return `
            <div class="queue-item">
                <h6 class="title light btn-tooltip" data-tooltip="${this._track.title}"><span>${this._track.title}</span><div class="pull-right">${__WEBPACK_IMPORTED_MODULE_0__js_utils__["a" /* default */].millisToMinutesAndSeconds(this._track.duration)}</div></h6>
